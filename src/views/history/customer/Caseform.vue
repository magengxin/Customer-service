  ...
  <div class="caseFrom">
    <a-form :form="form" @submit="handleSubmitContent">
        ...
        <a-col :span="24" style="width: 100%;" class="cloAuto">
          ...
          <a-row :gutter="24" type="flex" align="top">
            ...
            <a-col :span="12" :class="{ 'scroll-relative': scrollStatus }">
              <a-input-search v-model="caseData.question" @search="onSearch" enterButton="搜索"
                              size="small"></a-input-search>

              <scroll class="scroll-positon" v-show="scrollStatus">
                <a-table :columns="columns" :dataSource="this.caseList" bordered :customRow="customRow"
                         :rowKey="rowKey">
                </a-table>
              </scroll>
            </a-col>
      ...
      <a-row :gutter="24" style="margin-top: 10px;" type="flex" justify="space-around">
        <a-col :span="2">
          <a-button type="primary" style="height: 24px;" @click="addQAModal" :disabled='!disabledButon'>新增Note
          </a-button>
        </a-col>
        <a-col :span="6">
          <a-button type="primary"
                    html-type="submit"
                    style=" height: 24px;" :disabled='disabledButon'>保存
          </a-button>
          <a-button type="primary"
                    html-type="submit"
